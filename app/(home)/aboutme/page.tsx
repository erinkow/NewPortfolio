                ...
                <div className="flex flex-row items-center mt-10">
                    ...
                    <div className="ml-[9.5rem] max-w-[35rem] items-start">
                        <p className="text-lg text-neutral-300 breake-words">
                            ...
                            <br />
                            ソフトウェアエンジニアとしてはまだ駆け出しで、独学でJavaScriptやTypeScript, React, Next.JSといったフロントエンドの勉強を初めてからもうじき1年が経とうとしています。<br /> 
                            最近は個人のWebアプリケーション開発を中心に進めており、バックエンドの実装にも力を入れています。<br />
                            <br />
                            大学では英語を専攻、キャリアップのためもっと英語力を向上させたいと感じ大学卒業後新卒で入った会社を退職しイギリスへ留学。<br />
                            帰国後は主にPCパーツを扱う商社にて輸入事務や購買業務に携わってきました。<br />
                            <br />
                            長くパソコンに関わるようになり、徐々にソフトウェアの方に興味を持つようになった頃、ちょうどタイミング良く、前職の会社であるアメリカのサイバーセキュリティの会社の方から増員のため声をかけていただき、転職をしました。そこでは3年半バックオフィス兼営業事務として従事してまいりました。<br />
                            <br />
                            退職後は本格的にコードの勉強を始めました。Webアプリケーションをポートフォリオとして作成する上で、バックエンドの知識を養うために、ウェブアプリ開発の職業訓練(PHP+Laravel)も受講中です。<br />
                            <br />
