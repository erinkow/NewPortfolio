...
export const ContactThanks = () => {
    return(
        <div className='w-full h-full max-w-fill items-center px-[60rem] py-[350px] text-center'>
            <svg
                width='58'
                height='58'
            ...
            <h1 className="text-5xl leading-normal mb-[8px] p-0">Thank you!</h1>
            <p className="text-xl leading-1.5 m-0 p-0 text-#888">Your submission has been received.</p>
            <div className="mt-32 text-lg text-center">
                <Link className='text-2xl cursor-pointer font-bold' href='/'>Back to Home</Link>
            </div>
