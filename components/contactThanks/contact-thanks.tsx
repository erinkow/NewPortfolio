...
export const ContactThanks = () => {
    return(
        <div className='flex flex-col justify-center w-full h-full px-4 pt-[10rem] text-center md:px-auto'>
            ...
            <h1 className="text-2xl leading-normal mb-2 p-0 lg:text-5xl text-neutral-300">Thank you!</h1>
            <p className="text-base leading-normal m-0 p-0 text-neutral-400 lg:text-xl">Your submission has been received.</p>
            <div className="mt-8 text-lg text-center lg:mt-28">
                <Link className='text-xl cursor-pointer font-bold lg:text-2xl text-neutral-300' href='/'>Back to Home</Link>
            </div>
